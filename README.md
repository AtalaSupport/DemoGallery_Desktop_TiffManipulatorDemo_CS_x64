...
This is the C# version. We also offer a [VB.NET version](https://github.(mailto:sales@atalasoft.com)/AtalaSupport/DemoGallery_Desktop_TiffManipulatorDemo_VB_x64).
...
```bash
git clone https://github.(mailto:sales@atalasoft.com)/AtalaSupport/DemoGallery_Desktop_TiffManipulatorDemo_CS_x64.git TiffManipulatorDemo
```
